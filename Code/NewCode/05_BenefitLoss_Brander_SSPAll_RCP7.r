...
### SSP1
    ...
    scen_arealoss_perc_onlyCC <- read.csv(file="Results\\Area\\Proj_Area_Perc_OnlyCC_SSP170.csv")
    scen_arealoss_perc_onlygdp <- read.csv(file="Results\\Area\\Proj_Area_Perc_Onlygdp_SSP170.csv")
    scen_arealoss_perc_both <- read.csv(file="Results\\Area\\Proj_Area_Perc_both_SSP170.csv")
    scen_arealoss_perc_onlyCC$forcing <- "onlyCC"
    scen_arealoss_perc_onlygdp$forcing <- "onlygdp"
    scen_arealoss_perc_both$forcing <- "both"
    scen_arealoss_perc_onlyCC <- scen_arealoss_perc_onlyCC[,which(names(scen_arealoss_perc_onlyCC) %in% names(scen_arealoss_perc_both))]
...
### SSP2
    ...
    scen_arealoss_perc_onlyCC <- read.csv(file="Results\\Area\\Proj_Area_Perc_OnlyCC_SSP270.csv")
    scen_arealoss_perc_onlygdp <- read.csv(file="Results\\Area\\Proj_Area_Perc_Onlygdp_SSP270.csv")
    scen_arealoss_perc_both <- read.csv(file="Results\\Area\\Proj_Area_Perc_both_SSP270.csv")
    scen_arealoss_perc_onlyCC$forcing <- "onlyCC"
    scen_arealoss_perc_onlygdp$forcing <- "onlygdp"
    scen_arealoss_perc_both$forcing <- "both"
    scen_arealoss_perc_onlyCC <- scen_arealoss_perc_onlyCC[,which(names(scen_arealoss_perc_onlyCC) %in% names(scen_arealoss_perc_both))]
...
### SSP3
    ...
    scen_arealoss_perc_onlyCC <- read.csv(file="Results\\Area\\Proj_Area_Perc_OnlyCC_SSP370.csv")
    scen_arealoss_perc_onlygdp <- read.csv(file="Results\\Area\\Proj_Area_Perc_Onlygdp_SSP370.csv")
...
### SSP4
    ...
    scen_arealoss_perc_onlyCC <- read.csv(file="Results\\Area\\Proj_Area_Perc_OnlyCC_SSP470.csv")
    scen_arealoss_perc_onlygdp <- read.csv(file="Results\\Area\\Proj_Area_Perc_Onlygdp_SSP470.csv")
    scen_arealoss_perc_both <- read.csv(file="Results\\Area\\Proj_Area_Perc_both_SSP470.csv")
    scen_arealoss_perc_onlyCC$forcing <- "onlyCC"
    scen_arealoss_perc_onlygdp$forcing <- "onlygdp"
    scen_arealoss_perc_both$forcing <- "both"
    scen_arealoss_perc_onlyCC <- scen_arealoss_perc_onlyCC[,which(names(scen_arealoss_perc_onlyCC) %in% names(scen_arealoss_perc_both))]
