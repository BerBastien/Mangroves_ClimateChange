...
nc_file <- "C:/Users/basti/Box/Data/Oceans/MHWs/mangrove.mhw.stats.1996-2020.toolbox.nc"
...
for(vari in variable_names){
  br <- raster::rotate(brick(nc_file, varname=vari))
  for (j in 1:25){
  ...
  names(all_var_data)[3] <- "mhw_int_anom"

write.csv(all_var_data,"C:\\Users\\basti\\Documents\\GitHub\\Mangroves_ClimateChange\\Data\\input\\mhw_toolbox_full.csv")


nc_file <- "C:/Users/basti/Box/Data/Oceans/MHWs/mangrove.mcw.stats.1996-2020.toolbox.nc"
# Read the variable data from netCDF file
nc_data <- nc_open(nc_file)
print(nc_data)
...
for(vari in variable_names){
  ...
  glimpse(all_data)
  glimpse(all_var_data)
  names(all_var_data)[3] <- "mcw_int_anom"
...
# Rotate the raster
rotated_raster <- rotate(orig_raster)
...
write.csv(sampled_data,"C:\\Users\\basti\\Documents\\GitHub\\Mangroves_ClimateChange\\Data\\input\\mhw_toolbox.csv")
...
sampled_data <- sampled_data[which(sampled_data$year < 3000),]
sampled_data$year <- floor(sampled_data$year)
write.csv(sampled_data,"C:\\Users\\basti\\Documents\\GitHub\\Mangroves_ClimateChange\\Data\\input\\mcw_toolbox.csv")
