...
nc_file <- "C:\\Users\\basti\\Documents\\GitHub\\Mangroves_ClimateChange\\Data\\projections\\input\\mangrove.cesm2.lens.metrics.hist.SSP370.1850-2100.nc"
nc_data <- nc_open(nc_file)
print(nc_data)
variable_names <- names(nc_data$var)
...
gridcell_data <- st_read(gpkg_file)
  ...
  for (j in 151:251){ #25 years
    ...
    future_sst <- all_data
    write.csv(future_sst,"C:\\Users\\basti\\Documents\\GitHub\\Mangroves_ClimateChange\\Data\\projections\\sst_projection70.csv")
  ...
  for (j in 151:251){ #25 years
    ...
    write.csv(future_sst_hot,"C:\\Users\\basti\\Documents\\GitHub\\Mangroves_ClimateChange\\Data\\projections\\sst_hot_projection70.csv")
...
for (j in 151:251){ #25 years
    ...
    write.csv(all_data,"sst_bins_projection70_2.csv")